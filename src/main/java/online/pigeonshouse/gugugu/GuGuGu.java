...
public class GuGuGu {
    ...
    public void onInitialize() {
        ...
        MinecraftForge.EVENT_BUS.addListener(MinecraftServerEvents::onForgeChatEvent);
        MinecraftForge.EVENT_BUS.addListener(MinecraftServerEvents::onForgeRegisterCommandEvent);
